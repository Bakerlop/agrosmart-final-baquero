...
- **Nombre completo:** Fabricio Fernando Baquero López
- **Cédula:** 1719271643
- **NRC:** 30405
- **Código del examen:** `AGSK-2026`
- **Fecha y hora de inicio:** 2026-07-30 20:10
...
|:---:|-----------|-----------------|----------------------------|
| — | `NN` | los 2 últimos dígitos de mi cédula | 43                         |
| 1 | Nombre de la tabla | `tbl_productos_base_` + `NN` | tbl_productos_base_43      |
| 2 | Puerto | `81` + `NN` | 8143                       |
...
- **Enlace al video (5 min, cámara + pantalla):** https://drive.google.com/file/d/1CNhE3DlEjryiWwBWVeGNkysjnt5DRPNN/view?usp=sharing
- **Plataforma:** Google Drive                 <!-- Drive institucional / OneDrive / YouTube no listado -->
...
**Firma (nombre completo):** Fabricio Fernando Baquero López
